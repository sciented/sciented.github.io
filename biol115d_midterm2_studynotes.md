...
<div style="left: 0; width: 100%; height: 575px; position: relative;"><iframe src="https://flo.uri.sh/story/2086540/embed" style="top: 0; left: 0; width: 100%; height: 100%; position: absolute; border: 0;" allowfullscreen scrolling="no"></iframe></div>

## Second Mid-Term Exam Biology 115 Study Questions & Answers

```markdown
Note: Content from pp. 435-437 in [merged notes PDF](https://tinyurl.com/all-bio115d-schulze-merged)
```

---

### Outline Form of Peter's Coverage of the Second Mid-Term Exam

``Note: These questions begin on page 435 of the merged notes and end on page 437 of the merged notes. (Peter clearly indicates these are non-exhaustive on p. 430 of the merged notes.)`` 

#### Peter's Advice about Taking His Tests

``Note: Peter gives excellent advice from pp. 430-431 of the merged PDF on preparing for and taking his exams.`` 

On p. 431 of the merged PDF Peter defines the Exam Format to be:

>  "typically...==2—4 essay questions== and about ==35 multiple choice== or other ==short answer== questions."

---

#### Study Questions for Second Mid-Term Exam

1. **History and Future of Biological Diversity**

   1. According to present understanding, what are some of the **most important** events in the history of life on the planet, and **when** did they occur? ``Answers come directly from PowerPoint slides``

   2. From the perspective of *most* species, what is the *most* important difference between the **early** conditions on the planet and **present** conditions? 

   3. What are the **``three domains of life``**? What are their **fundamental** characteristics?
   ...
   7. **Cambrian Explosion & Mass Extinction Questions**
...
3. **Evolutionary Ancestry of Humans**
   ...
   1. What organisms constitute the primates? 
      ...
      ##### Speciation of Primates from Non-Primates
            ...
            1. Explanation of air movement associated with Hadley Cells.
               ...
               - When rising hot air and falling cold air collide, **heat energy is exchanged** and this exchange is movement-based.
                 - It’s all about the two different ***air pressures*** and ***air densities***:
                   - Hot *equatorial* air *rising* = **High** Pressure & **Low** Density; Cold 30-degrees *northern and southern* air *falling* = **Low** Pressure & **High** Density.  
...
1. What is the **key feature** of all scientific research/inquiry which differentiates it from all other types of human thought?
   ...
   2. Now it's time to introduce the concept of a ``null hypothesis`` and its opposite, the ``alternate hypothesis``.
      1. Using Example Hypothesis 1 from above, the stated hypothesis is *actually* the ``alternate hypothesis``.
